...
\inputminted{c}{code/posix_shared_memory_producer.c}
The consuming process can then read the contents of this shared memory
using the code below.
\inputminted{c}{code/posix_shared_memory_consumer.c}
\end{document}
